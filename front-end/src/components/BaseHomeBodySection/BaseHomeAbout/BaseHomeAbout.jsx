...
function BaseHomeAbout(props) {
    return (
        <div className={`baseHomeAbout mx-10 mt-20 ${props.className}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 aboutBackground py-16">
                ...
                <div className="mt-12 pl-12 min-[500px]:pl-16 md:pl-0 col-span-1 md:col-span-5 about-me-rightSection">
                    <div>
                        ...
                        <button id="introBtn1" className="introBtn bg-[#D2042D] mt-10">
