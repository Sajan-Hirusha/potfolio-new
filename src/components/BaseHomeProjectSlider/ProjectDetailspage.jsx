...
function ProjectDetailsPage() {
    ...
    return (
        <div>
            ...
            <div
                className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#141414] dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">{project.title || project.projectName}</h1>
                        {tags.length > 0 && (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="relative group">
                            <div className="overflow-hidden rounded-xl shadow-2xl">
                                <img
                                    ...
                                    className="w-full md:h-[300px] object-cover transition-transform duration-500 hover:scale-105"
                                />
                            </div>
                        ...
                        <div className="space-y-8">
                            <div>
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Project
                                    Overview</h2>
                            ...
                            {(project.features && project.features.length > 0) && (
                                <div>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Key
                                        Features</h2>
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        {project.liveUrl && (
                                            <a
                                                ...
                                                className="flex items-center px-4 min-[400px]:px-6  py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-md transition-colors duration-300"
                                            >
                                        ...
                                        {project.githubUrl && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center px-4 min-[400px]:px-6 py-3 bg-gray-800 hover:bg-gray-900 text-white rounded-lg shadow-md transition-colors duration-300"
                                            >
