function ItemCard(props) {
    return (
        <div
            className={`${props.class} itemCard bg-black/20 dark:bg-white/95 shadow-md rounded-lg text-center relative overflow-hidden transition-transform duration-300 ease-in-out hover:scale-105 mx-2 `}
